defmodule PhoenixgymWeb.ExerciseLive.Index do
  ...
  alias PhoenixgymWeb.GymComponents
    ...
    <Layouts.app flash={@flash} active_tab={:exercises} current_scope={@current_scope}>
      <div class="flex flex-col h-full">
        ...
        <div class="navbar bg-base-100 border-b border-base-300 sticky top-0 z-40 min-h-14 px-2">
          <div class="flex-1">
            <span class="font-semibold text-lg">{gettext("Exercises")}</span>
          </div>
          <div class="flex-none">
            <a href="/exercises/new" class="btn btn-ghost btn-sm gap-1">
              <.icon name="hero-plus" class="h-4 w-4" /> {gettext("Custom")}
            </a>
          </div>
        </div>
        ...
        <div class="p-3 space-y-2 bg-base-100 border-b border-base-300">
          ...
          <div class="flex gap-2 overflow-x-auto pb-1 scrollbar-hide">
            ...
            >
              {GymComponents.muscle_label(muscle)}
            </button>
          </div>
            ...
            <div class="flex-1 min-w-0">
              ...
              <div class="flex gap-1 mt-0.5">
                <span class="badge badge-sm badge-ghost">
                  {GymComponents.muscle_label(exercise.primary_muscle || "")}
                </span>
  ...
  def mount(_params, _session, socket) do
    ...
    socket =
      ...
      |> assign(:page_title, gettext("Exercises"))
